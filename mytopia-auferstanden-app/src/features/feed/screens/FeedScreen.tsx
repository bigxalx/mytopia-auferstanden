...
const styles = StyleSheet.create({
  ...
  modeBadge: { backgroundColor: '#f97316', borderRadius: 999, color: '#111827', fontSize: 11, fontWeight: '800', marginTop: 10, paddingHorizontal: 10, paddingVertical: 4, textTransform: 'uppercase' },
  errorBanner: { backgroundColor: '#7f1d1d', borderRadius: 12, padding: 12 },
  errorText: { color: '#fee2e2', fontSize: 13, lineHeight: 18 },
  stateBox: { alignItems: 'center', backgroundColor: '#1f2937', borderRadius: 12, gap: 8, padding: 20 },
  stateText: { color: '#e5e7eb', fontSize: 14 },
  messageRow: { flexDirection: 'row', alignItems: 'flex-start', position: 'relative' },
  avatarColumn: { position: 'absolute', left: 0, bottom: 0, width: 48 },
  bubbleContainer: { flex: 1, marginLeft: 60 },
  messageBubble: { backgroundColor: '#EDECE0', borderRadius: 10, flex: 1, padding: 10, gap: 8 },
  headline: { color: '#596161', fontFamily: 'NunitoSans_700Bold', fontSize: 13 },
  messageText: { color: '#000000', fontFamily: 'NunitoSans_400Regular', fontSize: 12, lineHeight: 18 },
  avatarImage: { borderRadius: 24, height: 48, width: 48 },
  avatarFallback: { alignItems: 'center', backgroundColor: '#64748b', borderRadius: 24, height: 48, justifyContent: 'center', width: 48 },
  avatarFallbackLabel: { color: '#f8fafc', fontSize: 18, fontWeight: '700' },
  attachmentBox: { backgroundColor: '#f3f4f6', borderRadius: 14, overflow: 'hidden' },
  attachmentCaption: { color: '#374151', fontSize: 14, paddingHorizontal: 12, paddingVertical: 10 },
  imageAttachment: { height: 220, width: '100%' },
  videoPlaceholder: { alignItems: 'center', backgroundColor: '#374151', height: 200, justifyContent: 'center', width: '100%', overflow: 'hidden' },
  videoOverlay: { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(0, 0, 0, 0.3)', alignItems: 'center', justifyContent: 'center' },
  playIconCircle: { width: 64, height: 64, borderRadius: 32, backgroundColor: 'rgba(0, 0, 0, 0.5)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255, 255, 255, 0.2)' },
  orange: { backgroundColor: '#F67641', borderRadius: 10, padding: 5 },
  missionCardImage: { borderRadius: 6, height: 140, width: '100%' },
  missionCardContent: { paddingHorizontal: 4, paddingBottom: 2 },
  missionTitle: { color: '#000000', fontFamily: 'Nunito_700Bold', fontSize: 15 },
  missionExcerpt: { color: '#000000', fontFamily: 'NunitoSans_400Regular', fontSize: 12, marginTop: 2 },
  audioHeader: { alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between', padding: 12 },
  audioTitle: { color: '#111827', flex: 1, fontSize: 15, fontWeight: '600', marginRight: 12 },
  audioButtonLabel: { color: '#111827', fontSize: 13, fontWeight: '700' },
  modalContainer: { backgroundColor: '#000000', flex: 1 },
  fullImage: { height: '100%', width: '100%' },
  loadMoreButton: { alignItems: 'center', backgroundColor: '#f97316', borderRadius: 12, paddingHorizontal: 16, paddingVertical: 12 },
  loadMoreButtonDisabled: { opacity: 0.7 },
  loadMoreLabel: { color: '#111827', fontSize: 14, fontWeight: '700' },
});
