...
export const FIRST_RUN_ONBOARDING_STEPS = {
  intro: {
    buttonLabel: 'Weiter',
    items: [
      { icon: 'theater-comedy', text: 'Mytopia verbindet Theater, Geschichte und digitales Spiel in einer gemeinsamen App.' },
    ...
    title: 'Willkommen bei Mytopia',
  },
  location: {
    buttonLabel: 'Weiter',
    items: [
      { icon: 'place', text: 'Einige Missionen beziehen Orte in der Stadt mit ein und zeigen dir den Weg dorthin.' },
      { icon: 'map', text: 'Mit Standortzugriff siehst du Karte, Entfernung und Check-in-Zonen direkt in der App.' },
